...
REM Make all relative paths resolve from this launcher directory.
cd /d "%~dp0"
...
REM -l option.  Users could also modify the command below to use the -b option
REM to a Model Interface Batch Command file.
